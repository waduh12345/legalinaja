...
export default function ZakatPage() {
  ...
  const zakatDonations = getDonationsByCategory("zakat");
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      {/* Header */}
      <div className="bg-gradient-to-r from-warning to-warning/80 text-white">
        <div className="max-w-md mx-auto px-4 py-6">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h1 className="text-2xl font-bold font-comfortaa">Zakat</h1>
            </div>
            <p className="text-white/90 font-comfortaa max-w-2xl mx-auto">
              Zakat adalah kewajiban bagi setiap muslim yang mampu. Mari
              tunaikan zakat fitrah dan zakat mal untuk membersihkan harta dan
              jiwa
            </p>
          </div>
        </div>
      ...
      <div className="max-w-md mx-auto px-4 py-6">
        ...
        <Card className="border-awqaf-border-light mb-6">
          <CardContent className="p-6">
            <div className="grid grid-cols-1 gap-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-warning font-comfortaa mb-1">
                  {zakatDonations.length}
                </div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-warning font-comfortaa mb-1">
                  {formatCurrency(
                    zakatDonations.reduce((sum, d) => sum + d.currentAmount, 0)
                  )}
                </div>
                <div className="text-sm text-awqaf-foreground-secondary font-comfortaa">
                  Total Terkumpul
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-warning font-comfortaa mb-1">
                  {formatNumber(
                    zakatDonations.reduce((sum, d) => sum + d.donorCount, 0)
                  )}
                </div>
                <div className="text-sm text-awqaf-foreground-secondary font-comfortaa">
                  Total Donatur
                ...
                <CardContent className="p-4">
                  ...
                  <div className="mb-3">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-xs font-medium text-warning font-comfortaa">
                        {donation.progress}%
                      </span>
                    </div>
                    <Progress
                  ...
                  <Button
                    ...
                    className="w-full bg-warning hover:bg-warning/90 text-white text-xs font-comfortaa"
                    size="sm"
                  >
                    Bayar Zakat
                  </Button>
        ...
        <Card className="border-awqaf-border-light bg-gradient-to-r from-accent-100 to-accent-200 mt-8">
          <CardContent className="p-6 text-center">
            <p className="text-sm text-warning font-comfortaa mb-2">
