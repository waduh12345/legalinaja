...
// --- Data Diubah untuk Cek Merek Dagang (ID "3") ---
...
export default function CekMerekPage() {
  ...
  // --- State Diubah ---
  const [namaMerek, setNamaMerek] = useState(""); // <-- Input Baru
  const [jenisLayanan, setJenisLayanan] = useState(""); // <-- Input Baru
  ...
  const handleSubmit = () => {
    // Validasi input
    if (!namaMerek) {
      setError("Nama merek tidak boleh kosong.");
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 pb-20">
      <main className="max-w-md mx-auto px-4 py-6 space-y-5">
        ...
        <Card className="border-gray-200 bg-white">
          <CardContent className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <Badge
                variant="secondary"
                className="text-xs bg-indigo-100 text-indigo-700 mb-0.5"
              >
                Layanan Cek
              </Badge>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              <Label
                ...
                className="font-semibold text-gray-700 mb-2 text-sm"
              >
                Jenis Usaha/Layanan (Opsional)
              </Label>
              <Textarea
                id="jenisLayanan"
                placeholder="Contoh: Jasa konsultasi hukum, Aplikasi mobile."
                value={jenisLayanan}
        ...
        <Button
          ...
          disabled={isSubmitting || !namaMerek}
        >
          {isSubmitting ? (
