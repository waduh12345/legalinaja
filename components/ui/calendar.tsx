...
import { buttonVariants } from "@/components/ui/button" // Asumsi Anda memiliki button variants
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-blue-600 text-white hover:bg-blue-600 hover:text-white focus:bg-blue-600 focus:text-white", // <-- Penyesuaian Brand LegalAja
